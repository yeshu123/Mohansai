...
export class ProgramComponent implements OnInit {
  ...
  // let delayDays = 0; // initialize delayDays variable outside the function
  ...
  getDelayDays(item: any) {
    ...
    if (item.programStatus === 'Submitted' && diffDays > 0) {
      delayDays = diffDays;
    } else if (item.programStatus === 'Approved' || item.programStatus === 'Under Review') {
      delayDays = 0;
    }
